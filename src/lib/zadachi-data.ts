...
export const THEME_LABELS: Record<string, string> = {
  ...
  trappedPiece: "Ловушка фигуры",
  xRayAttack: "Рентген",
  exposedKing: "Открытый король",
  kingsideAttack: "Атака на короля",
  queensideAttack: "Ферзевый фланг",
  castling: "Рокировка",
  ...
  master: "Мастерская партия",
  masterVsMaster: "Мастер vs мастер",
  superGM: "Супер-ГМ",
};

/** Themes shown as filter chips even before a DB hit returns them. */
export const COMMON_PUZZLE_THEMES = [
  "mateIn1",
  "mateIn2",
  "mateIn3",
  "fork",
