...
insert into public.puzzles (id, fen, moves, themes, rating) values
  ...
  ('discover-1', 'r2qkb1r/ppp2ppp/2n1bn2/3pp3/4P3/2NP1N2/PPP1BPPP/R1BQK2R w KQkq - 0 6', array['f3e5'], array['discoveredAttack','material'], 1200),
  ('mate2-1', '2r3k1/5ppp/8/8/8/8/5PPP/2R3K1 w - - 0 1', array['c1c8'], array['mateIn1','backRank','mate'], 1100),
  ('mate2-2', '6k1/5ppp/8/8/8/5Q2/5PPP/6K1 w - - 0 1', array['f3f7','g8h8','f7f8'], array['mateIn2','mate'], 1250),
  ('skewer-1', 'q6k/8/8/8/8/8/8/R6K w - - 0 1', array['a1a8'], array['skewer','endgame'], 1000),
  ...
  ('endgame-2', '6k1/8/6K1/8/8/8/8/5R2 w - - 0 1', array['f1f8'], array['endgame','mateIn1','mate'], 850),
